...
- Spend velocity: >3σ above 30-day daily average
...
5. ML confidence score + feature contribution breakdown
...
Confirmed Tier 1 signal present?
  YES → Is account owner contactable?
          YES → Immediate restriction (Level 3) + urgent owner notification
                 ...
                 Account owner cannot be reached within 4hr → escalate to Level 4 hold
  ...
  NO  → Two Tier 2 signals?
          ...
          NO  → Level 0 (monitor) + flag for 72hr watch
```
...
**Initial notice (sent within 1 hour of action):**
...
|---|---|---|
| **ATO catch rate** | % of confirmed ATO events detected before >$X spend | >95% |
| **False action rate** | % of ATO actions where legitimate owner was never compromised | <1% |
| **Detection-to-action window** | Time from first Tier 1 signal to enforcement action | <2hr (P0) |
| **Owner recovery SLA** | Time from legitimate owner contact to account restoration | <4hr |
| **Fraudulent spend recovered** | % of spend from ATO period successfully waived/recovered | Tracked |

---

*See also: [Impersonation Playbook](impersonation.md) · [Policy Circumvention Playbook](policy-circumvention.md)*
